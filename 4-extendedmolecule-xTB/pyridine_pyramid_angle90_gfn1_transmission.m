...
Hmatrix = readmatrix('pyridine-pyramid-angle90-gfn1_hamiltonian_matrix_xtb.csv');
H_without_first_column = Hmatrix(2:end,: );
H = 27.2114 * H_without_first_column;

Smatrix = readmatrix('pyridine-pyramid-angle90-gfn1_overlap_matrix_xtb.csv');
S = Smatrix(2:end,: ); 

Cmatrix = readmatrix('pyridine-pyramid-angle90-gfn1_orbital-coefficients_xtb.csv');
C_without_first_column = Cmatrix(2:end,: );
C = C_without_first_column';

Ematrix = diag(readmatrix('pyridine-pyramid-angle90-gfn1_orbital-energies_xtb.csv'));
